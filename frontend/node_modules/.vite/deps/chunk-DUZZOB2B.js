...
var ICONS = {
  add: async () => (await import("./add-ZF7JBQRX.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZHJFO6QJ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WBRWQN6Y.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-M5GJUKPT.js")).appStoreSvg,
  apple: async () => (await import("./apple-M35VWPKD.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-74THODOS.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-FYMBPN27.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-2IDGRINL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-6YAFKEZC.js")).arrowTopSvg,
  bank: async () => (await import("./bank-T6OYV67R.js")).bankSvg,
  browser: async () => (await import("./browser-EVHI2P3T.js")).browserSvg,
  card: async () => (await import("./card-DRZ3KGZC.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZCFT5VJG.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-FOWR44TK.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-LGYIDLXV.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-5UTLYQZG.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-43GQPD6D.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-BCCJXUOU.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-I3V3ULP6.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ZHCYJPPM.js")).clockSvg,
  close: async () => (await import("./close-MUDNYIVQ.js")).closeSvg,
  compass: async () => (await import("./compass-C4C2H3DD.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-KVG6QLWA.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-KBJK3XPR.js")).copySvg,
  cursor: async () => (await import("./cursor-XF44JXIR.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-ZYBRZIF4.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-SPNCV2A5.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-TNY5XLOB.js")).disconnectSvg,
  discord: async () => (await import("./discord-7ZRW633J.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-DN6RXOKS.js")).etherscanSvg,
  extension: async () => (await import("./extension-L4ZWDKMD.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-OPAMN5KL.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-FKD7LA4Q.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-6L4VW6F7.js")).farcasterSvg,
  filters: async () => (await import("./filters-SUYQLQ3P.js")).filtersSvg,
  github: async () => (await import("./github-SSDM7TKD.js")).githubSvg,
  google: async () => (await import("./google-52LHF55R.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-HZ6ZCMHU.js")).helpCircleSvg,
  image: async () => (await import("./image-DCSJTJUX.js")).imageSvg,
  id: async () => (await import("./id-H3F7ZARU.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-BTUAOI5X.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-ZLPUYT4T.js")).lightbulbSvg,
  mail: async () => (await import("./mail-AXQSYXZF.js")).mailSvg,
  mobile: async () => (await import("./mobile-3EPYFO4N.js")).mobileSvg,
  more: async () => (await import("./more-J36GG7BH.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-4ZK2QPO2.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-YUG5RN5T.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-Y3FISUWL.js")).offSvg,
  playStore: async () => (await import("./play-store-DCGDVWQI.js")).playStoreSvg,
  plus: async () => (await import("./plus-RO4JXZPQ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-H4J56DNK.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-NL6HHWXG.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-PTM3OFXM.js")).refreshSvg,
  search: async () => (await import("./search-YREPVHSZ.js")).searchSvg,
  send: async () => (await import("./send-JHQYMCUS.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-UPCY74SB.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BTCJPUW5.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-M3ZPYSXX.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-4BYOJYMU.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HKZZORJC.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-T7B6644S.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-LVECCLLC.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-HEO6CC7T.js")).twitchSvg,
  twitter: async () => (await import("./x-PGOS7XEH.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-ZQEHKW7T.js")).twitterIconSvg,
  verify: async () => (await import("./verify-LMLN4OQR.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-5XZRTRTV.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GOXL3BQ2.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-LTSVKM7O.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-LTSVKM7O.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-LTSVKM7O.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CQWPS7AA.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-4EJHVYVJ.js")).warningCircleSvg,
  x: async () => (await import("./x-PGOS7XEH.js")).xSvg,
  info: async () => (await import("./info-7TJYAOYY.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-GX2UTLSU.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-5I47YYWY.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DUZZOB2B.js.map
