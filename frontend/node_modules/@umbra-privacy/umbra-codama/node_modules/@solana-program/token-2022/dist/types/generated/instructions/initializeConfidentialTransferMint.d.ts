...
export declare function getInitializeConfidentialTransferMintDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
export declare const INITIALIZE_CONFIDENTIAL_TRANSFER_MINT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR = 0;
export declare function getInitializeConfidentialTransferMintConfidentialTransferDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
