...
export declare function extension(kind: 'ConfidentialMintBurn', data: GetDiscriminatedUnionVariantContent<ExtensionArgs, '__kind', 'ConfidentialMintBurn'>): GetDiscriminatedUnionVariant<ExtensionArgs, '__kind', 'ConfidentialMintBurn'>;
...
export declare function extension(kind: 'PausableAccount', data: GetDiscriminatedUnionVariantContent<ExtensionArgs, '__kind', 'PausableAccount'>): GetDiscriminatedUnionVariant<ExtensionArgs, '__kind', 'PausableAccount'>;
export declare function extension(kind: 'PermissionedBurn', data: GetDiscriminatedUnionVariantContent<ExtensionArgs, '__kind', 'PermissionedBurn'>): GetDiscriminatedUnionVariant<ExtensionArgs, '__kind', 'PermissionedBurn'>;
