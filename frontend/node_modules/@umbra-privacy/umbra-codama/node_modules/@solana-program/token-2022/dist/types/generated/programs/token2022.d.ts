...
export declare enum Token2022Instruction {
    ...
    UnwrapLamports = 87,
    InitializePermissionedBurn = 88,
    PermissionedBurn = 89,
    PermissionedBurnChecked = 90
}
...
export declare function parseToken2022Instruction<TProgram extends string>(instruction: Instruction<TProgram> & InstructionWithData<ReadonlyUint8Array>): ParsedToken2022Instruction<TProgram>;
