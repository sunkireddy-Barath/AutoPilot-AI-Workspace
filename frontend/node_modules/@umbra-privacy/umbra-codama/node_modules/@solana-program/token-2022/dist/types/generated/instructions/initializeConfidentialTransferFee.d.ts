...
export declare function getInitializeConfidentialTransferFeeDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
export declare const INITIALIZE_CONFIDENTIAL_TRANSFER_FEE_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR = 0;
export declare function getInitializeConfidentialTransferFeeConfidentialTransferFeeDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
