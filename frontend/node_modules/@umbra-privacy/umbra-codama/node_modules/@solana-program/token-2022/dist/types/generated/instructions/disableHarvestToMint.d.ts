...
export declare function getDisableHarvestToMintDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
export declare const DISABLE_HARVEST_TO_MINT_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR = 5;
export declare function getDisableHarvestToMintConfidentialTransferFeeDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
