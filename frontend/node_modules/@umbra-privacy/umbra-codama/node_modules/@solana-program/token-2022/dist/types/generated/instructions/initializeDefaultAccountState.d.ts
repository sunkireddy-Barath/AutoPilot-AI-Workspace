...
export declare function getInitializeDefaultAccountStateDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
export declare const INITIALIZE_DEFAULT_ACCOUNT_STATE_DEFAULT_ACCOUNT_STATE_DISCRIMINATOR = 0;
export declare function getInitializeDefaultAccountStateDefaultAccountStateDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
