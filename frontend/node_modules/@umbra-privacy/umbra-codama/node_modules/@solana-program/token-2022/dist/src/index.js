...
var AuthorityType = /* @__PURE__ */ ((AuthorityType2) => {
  ...
  AuthorityType2[AuthorityType2["PermissionedBurn"] = 17] = "PermissionedBurn";
...
function getDecryptableBalanceCodec() {
  return kit.combineCodec(getDecryptableBalanceEncoder(), getDecryptableBalanceDecoder());
}
...
function getEncryptedBalanceCodec() {
  return kit.combineCodec(getEncryptedBalanceEncoder(), getEncryptedBalanceDecoder());
}
function getExtensionEncoder() {
  return kit.getDiscriminatedUnionEncoder(
    [
      ...
      [
        "TransferFeeAmount",
        kit.addEncoderSizePrefix(kit.getStructEncoder([["withheldAmount", kit.getU64Encoder()]]), kit.getU16Encoder())
      ],
      [
        "MintCloseAuthority",
        kit.addEncoderSizePrefix(kit.getStructEncoder([["closeAuthority", kit.getAddressEncoder()]]), kit.getU16Encoder())
      ],
      [
        "ConfidentialTransferMint",
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([
            ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
            ["autoApproveNewAccounts", kit.getBooleanEncoder()],
            [
              "auditorElgamalPubkey",
              kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })
            ]
          ]),
          kit.getU16Encoder()
        )
      ...
      [
        "DefaultAccountState",
        kit.addEncoderSizePrefix(kit.getStructEncoder([["state", getAccountStateEncoder()]]), kit.getU16Encoder())
      ],
      ["ImmutableOwner", kit.addEncoderSizePrefix(kit.getStructEncoder([]), kit.getU16Encoder())],
      [
        "MemoTransfer",
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([["requireIncomingTransferMemos", kit.getBooleanEncoder()]]),
          kit.getU16Encoder()
        )
      ],
      ["NonTransferable", kit.addEncoderSizePrefix(kit.getStructEncoder([]), kit.getU16Encoder())],
      [
      ...
      ["CpiGuard", kit.addEncoderSizePrefix(kit.getStructEncoder([["lockCpi", kit.getBooleanEncoder()]]), kit.getU16Encoder())],
      [
        "PermanentDelegate",
        kit.addEncoderSizePrefix(kit.getStructEncoder([["delegate", kit.getAddressEncoder()]]), kit.getU16Encoder())
      ],
      ["NonTransferableAccount", kit.addEncoderSizePrefix(kit.getStructEncoder([]), kit.getU16Encoder())],
      [
        "TransferHook",
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([
      ...
      [
        "TransferHookAccount",
        kit.addEncoderSizePrefix(kit.getStructEncoder([["transferring", kit.getBooleanEncoder()]]), kit.getU16Encoder())
      ],
      [
      ...
      [
        ...
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([
            ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
            ["groupAddress", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
          ]),
          kit.getU16Encoder()
        )
      ],
      ...
      [
        ...
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([
            ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
            ["memberAddress", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
          ]),
          kit.getU16Encoder()
        )
      ],
      ...
      ["ConfidentialMintBurn", kit.addEncoderSizePrefix(kit.getStructEncoder([]), kit.getU16Encoder())],
      [
      ...
      ["PausableAccount", kit.addEncoderSizePrefix(kit.getStructEncoder([]), kit.getU16Encoder())],
      [
        "PermissionedBurn",
        kit.addEncoderSizePrefix(
          kit.getStructEncoder([
...
function getExtensionDecoder() {
  return kit.getDiscriminatedUnionDecoder(
    [
      ...
      [
        "TransferFeeAmount",
        kit.addDecoderSizePrefix(kit.getStructDecoder([["withheldAmount", kit.getU64Decoder()]]), kit.getU16Decoder())
      ],
      [
        "MintCloseAuthority",
        kit.addDecoderSizePrefix(kit.getStructDecoder([["closeAuthority", kit.getAddressDecoder()]]), kit.getU16Decoder())
      ],
      [
        "ConfidentialTransferMint",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
            ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
            ["autoApproveNewAccounts", kit.getBooleanDecoder()],
            [
              "auditorElgamalPubkey",
              kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })
            ]
          ]),
          kit.getU16Decoder()
        )
      ...
      [
        "DefaultAccountState",
        kit.addDecoderSizePrefix(kit.getStructDecoder([["state", getAccountStateDecoder()]]), kit.getU16Decoder())
      ],
      ["ImmutableOwner", kit.addDecoderSizePrefix(kit.getStructDecoder([]), kit.getU16Decoder())],
      [
        "MemoTransfer",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([["requireIncomingTransferMemos", kit.getBooleanDecoder()]]),
          kit.getU16Decoder()
        )
      ],
      ["NonTransferable", kit.addDecoderSizePrefix(kit.getStructDecoder([]), kit.getU16Decoder())],
      [
        "InterestBearingConfig",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
      ...
      ["CpiGuard", kit.addDecoderSizePrefix(kit.getStructDecoder([["lockCpi", kit.getBooleanDecoder()]]), kit.getU16Decoder())],
      [
        "PermanentDelegate",
        kit.addDecoderSizePrefix(kit.getStructDecoder([["delegate", kit.getAddressDecoder()]]), kit.getU16Decoder())
      ],
      ["NonTransferableAccount", kit.addDecoderSizePrefix(kit.getStructDecoder([]), kit.getU16Decoder())],
      [
        "TransferHook",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
      ...
      [
        "TransferHookAccount",
        kit.addDecoderSizePrefix(kit.getStructDecoder([["transferring", kit.getBooleanDecoder()]]), kit.getU16Decoder())
      ],
      [
        "ConfidentialTransferFee",
        kit.addDecoderSizePrefix(
      ...
      [
        ...
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
            ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
            ["groupAddress", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
          ]),
          kit.getU16Decoder()
        )
      ],
      ...
      [
        ...
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
            ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
            ["memberAddress", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
          ]),
          kit.getU16Decoder()
        )
      ],
      ...
      ["ConfidentialMintBurn", kit.addDecoderSizePrefix(kit.getStructDecoder([]), kit.getU16Decoder())],
      [
        "ScaledUiAmountConfig",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
      ...
      ["PausableAccount", kit.addDecoderSizePrefix(kit.getStructDecoder([]), kit.getU16Decoder())],
      [
        "PermissionedBurn",
        kit.addDecoderSizePrefix(
          kit.getStructDecoder([
...
function getTokenMetadataFieldEncoder() {
  return kit.getDiscriminatedUnionEncoder([
    ...
    [
      "Key",
      kit.getStructEncoder([["fields", kit.getTupleEncoder([kit.addEncoderSizePrefix(kit.getUtf8Encoder(), kit.getU32Encoder())])]])
    ]
  ]);
}
function getTokenMetadataFieldDecoder() {
  return kit.getDiscriminatedUnionDecoder([
    ...
    [
      "Key",
      kit.getStructDecoder([["fields", kit.getTupleDecoder([kit.addDecoderSizePrefix(kit.getUtf8Decoder(), kit.getU32Decoder())])]])
    ]
  ]);
}
function getTokenMetadataFieldCodec() {
  return kit.combineCodec(getTokenMetadataFieldEncoder(), getTokenMetadataFieldDecoder());
}
  ...
  return kit.getStructEncoder([
    ...
    [
      ...
      kit.getOptionEncoder(
        kit.getHiddenPrefixEncoder(kit.getArrayEncoder(getExtensionEncoder(), { size: "remainder" }), [
  ...
  return kit.getStructDecoder([
    ...
    [
      ...
      kit.getOptionDecoder(
        kit.getHiddenPrefixDecoder(kit.getArrayDecoder(getExtensionDecoder(), { size: "remainder" }), [
...
function getApplyConfidentialPendingBalanceDiscriminatorBytes() {
  return kit.getU8Encoder().encode(APPLY_CONFIDENTIAL_PENDING_BALANCE_DISCRIMINATOR);
}
...
function getApplyConfidentialPendingBalanceConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(APPLY_CONFIDENTIAL_PENDING_BALANCE_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getApproveConfidentialTransferAccountDiscriminatorBytes() {
  return kit.getU8Encoder().encode(APPROVE_CONFIDENTIAL_TRANSFER_ACCOUNT_DISCRIMINATOR);
}
...
function getApproveConfidentialTransferAccountConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(APPROVE_CONFIDENTIAL_TRANSFER_ACCOUNT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getConfidentialDepositConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CONFIDENTIAL_DEPOSIT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getConfidentialTransferConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CONFIDENTIAL_TRANSFER_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getConfidentialTransferWithFeeConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CONFIDENTIAL_TRANSFER_WITH_FEE_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
function getConfidentialTransferWithFeeInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["newSourceDecryptableAvailableBalance", getDecryptableBalanceEncoder()],
      ["equalityProofInstructionOffset", kit.getI8Encoder()],
      ["transferAmountCiphertextValidityProofInstructionOffset", kit.getI8Encoder()],
...
function getConfidentialWithdrawConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CONFIDENTIAL_WITHDRAW_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getConfigureConfidentialTransferAccountConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(CONFIGURE_CONFIDENTIAL_TRANSFER_ACCOUNT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getCreateNativeMintInstructionDataCodec() {
  return kit.combineCodec(getCreateNativeMintInstructionDataEncoder(), getCreateNativeMintInstructionDataDecoder());
}
...
function getDisableConfidentialCreditsConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(DISABLE_CONFIDENTIAL_CREDITS_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getDisableCpiGuardInstructionDataCodec() {
  return kit.combineCodec(getDisableCpiGuardInstructionDataEncoder(), getDisableCpiGuardInstructionDataDecoder());
}
...
function getDisableHarvestToMintConfidentialTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(DISABLE_HARVEST_TO_MINT_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getDisableMemoTransfersMemoTransfersDiscriminatorBytes() {
  return kit.getU8Encoder().encode(DISABLE_MEMO_TRANSFERS_MEMO_TRANSFERS_DISCRIMINATOR);
}
...
function getDisableNonConfidentialCreditsConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(DISABLE_NON_CONFIDENTIAL_CREDITS_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
var EMIT_TOKEN_METADATA_DISCRIMINATOR = new Uint8Array([250, 166, 180, 250, 13, 12, 184, 70]);
...
function getEmptyConfidentialTransferAccountDiscriminatorBytes() {
  return kit.getU8Encoder().encode(EMPTY_CONFIDENTIAL_TRANSFER_ACCOUNT_DISCRIMINATOR);
}
...
function getEmptyConfidentialTransferAccountConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(EMPTY_CONFIDENTIAL_TRANSFER_ACCOUNT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getEnableCpiGuardInstructionDataCodec() {
  return kit.combineCodec(getEnableCpiGuardInstructionDataEncoder(), getEnableCpiGuardInstructionDataDecoder());
}
...
function getEnableHarvestToMintConfidentialTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(ENABLE_HARVEST_TO_MINT_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getEnableHarvestToMintInstructionDataCodec() {
  return kit.combineCodec(getEnableHarvestToMintInstructionDataEncoder(), getEnableHarvestToMintInstructionDataDecoder());
}
...
function getEnableMemoTransfersInstructionDataCodec() {
  return kit.combineCodec(getEnableMemoTransfersInstructionDataEncoder(), getEnableMemoTransfersInstructionDataDecoder());
}
...
function getEnableNonConfidentialCreditsConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(ENABLE_NON_CONFIDENTIAL_CREDITS_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
...
function getHarvestWithheldTokensToMintTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(HARVEST_WITHHELD_TOKENS_TO_MINT_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getHarvestWithheldTokensToMintInstruction(input, config) {
  ...
  const accounts = originalAccounts;
  const args = { ...input };
  const remainingAccounts = args.sources.map((address) => ({ address, role: kit.AccountRole.WRITABLE }));
  const getAccountMeta = getAccountMetaFactory(programAddress);
  return Object.freeze({
...
function getInitializeConfidentialTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getInitializeConfidentialTransferFeeConfidentialTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_CONFIDENTIAL_TRANSFER_FEE_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getInitializeConfidentialTransferMintDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_CONFIDENTIAL_TRANSFER_MINT_DISCRIMINATOR);
}
...
function getInitializeConfidentialTransferMintConfidentialTransferDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_CONFIDENTIAL_TRANSFER_MINT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR);
}
function getInitializeConfidentialTransferMintInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
      ["autoApproveNewAccounts", kit.getBooleanEncoder()],
      ["auditorElgamalPubkey", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
    ]),
    (value) => ({
      ...value,
...
function getInitializeConfidentialTransferMintInstructionDataDecoder() {
  return kit.getStructDecoder([
    ...
    ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
    ["autoApproveNewAccounts", kit.getBooleanDecoder()],
    ["auditorElgamalPubkey", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
  ]);
}
...
function getInitializeDefaultAccountStateDefaultAccountStateDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_DEFAULT_ACCOUNT_STATE_DEFAULT_ACCOUNT_STATE_DISCRIMINATOR);
}
...
function getInitializeGroupMemberPointerGroupMemberPointerDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_GROUP_MEMBER_POINTER_GROUP_MEMBER_POINTER_DISCRIMINATOR);
}
...
function getInitializeInterestBearingMintInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["rateAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
...
function getInitializeInterestBearingMintInstructionDataDecoder() {
  return kit.getStructDecoder([
    ...
    ["rateAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
...
function getInitializeMetadataPointerMetadataPointerDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_METADATA_POINTER_METADATA_POINTER_DISCRIMINATOR);
}
function getInitializeMetadataPointerInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
      ["metadataAddress", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
    ]),
    (value) => ({
      ...value,
...
function getInitializeMetadataPointerInstructionDataDecoder() {
  return kit.getStructDecoder([
    ...
    ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
    ["metadataAddress", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
  ]);
}
...
function getInitializePausableConfigPausableDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_PAUSABLE_CONFIG_PAUSABLE_DISCRIMINATOR);
}
...
var INITIALIZE_PERMISSIONED_BURN_DISCRIMINATOR = 46;
function getInitializePermissionedBurnDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_PERMISSIONED_BURN_DISCRIMINATOR);
}
var INITIALIZE_PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR = 0;
function getInitializePermissionedBurnPermissionedBurnDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR);
}
function getInitializePermissionedBurnInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      ["permissionedBurnDiscriminator", kit.getU8Encoder()],
      ["authority", kit.getAddressEncoder()]
    ]),
    (value) => ({
      ...value,
...
function getInitializePermissionedBurnInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    ["permissionedBurnDiscriminator", kit.getU8Decoder()],
    ["authority", kit.getAddressDecoder()]
  ]);
}
function getInitializePermissionedBurnInstructionDataCodec() {
  return kit.combineCodec(
    getInitializePermissionedBurnInstructionDataEncoder(),
    getInitializePermissionedBurnInstructionDataDecoder()
  );
}
function getInitializePermissionedBurnInstruction(input, config) {
  const programAddress = config?.programAddress ?? TOKEN_2022_PROGRAM_ADDRESS;
  const originalAccounts = { mint: { value: input.mint ?? null, isWritable: true } };
  const accounts = originalAccounts;
  const args = { ...input };
...
function parseInitializePermissionedBurnInstruction(instruction) {
  if (instruction.accounts.length < 1) {
    throw new Error("Not enough accounts");
  }
  let accountIndex = 0;
...
function getInitializeScaledUiAmountMintScaledUiAmountMintDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_SCALED_UI_AMOUNT_MINT_SCALED_UI_AMOUNT_MINT_DISCRIMINATOR);
}
...
var INITIALIZE_TOKEN_GROUP_DISCRIMINATOR = new Uint8Array([121, 113, 108, 39, 54, 51, 0, 4]);
...
function getInitializeTokenGroupInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getBytesEncoder()],
      ["updateAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
      ["maxSize", kit.getU64Encoder()]
    ]),
...
function getInitializeTokenGroupInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getBytesDecoder()],
    ["updateAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
    ["maxSize", kit.getU64Decoder()]
  ]);
}
...
var INITIALIZE_TOKEN_GROUP_MEMBER_DISCRIMINATOR = new Uint8Array([152, 32, 222, 176, 223, 237, 116, 134]);
...
function getInitializeTokenGroupMemberInstructionDataEncoder() {
  return kit.transformEncoder(kit.getStructEncoder([["discriminator", kit.getBytesEncoder()]]), (value) => ({
    ...value,
...
var INITIALIZE_TOKEN_METADATA_DISCRIMINATOR = new Uint8Array([210, 225, 30, 162, 88, 184, 77, 141]);
...
function getInitializeTransferFeeConfigTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_TRANSFER_FEE_CONFIG_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getInitializeTransferHookTransferHookDiscriminatorBytes() {
  return kit.getU8Encoder().encode(INITIALIZE_TRANSFER_HOOK_TRANSFER_HOOK_DISCRIMINATOR);
}
function getInitializeTransferHookInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })],
      ["programId", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
    ]),
    (value) => ({
      ...value,
...
function getInitializeTransferHookInstructionDataDecoder() {
  return kit.getStructDecoder([
    ...
    ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })],
    ["programId", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
  ]);
}
...
function getPauseInstructionDataCodec() {
  return kit.combineCodec(getPauseInstructionDataEncoder(), getPauseInstructionDataDecoder());
}
...
var PERMISSIONED_BURN_DISCRIMINATOR = 46;
function getPermissionedBurnDiscriminatorBytes() {
  return kit.getU8Encoder().encode(PERMISSIONED_BURN_DISCRIMINATOR);
}
var PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR = 1;
function getPermissionedBurnPermissionedBurnDiscriminatorBytes() {
  return kit.getU8Encoder().encode(PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR);
}
function getPermissionedBurnInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      ["permissionedBurnDiscriminator", kit.getU8Encoder()],
...
function getPermissionedBurnInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    ["permissionedBurnDiscriminator", kit.getU8Decoder()],
    ["amount", kit.getU64Decoder()]
...
function getPermissionedBurnInstructionDataCodec() {
  return kit.combineCodec(getPermissionedBurnInstructionDataEncoder(), getPermissionedBurnInstructionDataDecoder());
}
function getPermissionedBurnInstruction(input, config) {
  const programAddress = config?.programAddress ?? TOKEN_2022_PROGRAM_ADDRESS;
  const originalAccounts = {
    account: { value: input.account ?? null, isWritable: true },
    mint: { value: input.mint ?? null, isWritable: true },
  ...
  return Object.freeze({
    ...
    data: getPermissionedBurnInstructionDataEncoder().encode(args),
    programAddress
  });
}
function parsePermissionedBurnInstruction(instruction) {
  if (instruction.accounts.length < 4) {
    throw new Error("Not enough accounts");
  }
  let accountIndex = 0;
...
var PERMISSIONED_BURN_CHECKED_DISCRIMINATOR = 46;
function getPermissionedBurnCheckedDiscriminatorBytes() {
  return kit.getU8Encoder().encode(PERMISSIONED_BURN_CHECKED_DISCRIMINATOR);
}
var PERMISSIONED_BURN_CHECKED_PERMISSIONED_BURN_DISCRIMINATOR = 2;
function getPermissionedBurnCheckedPermissionedBurnDiscriminatorBytes() {
  return kit.getU8Encoder().encode(PERMISSIONED_BURN_CHECKED_PERMISSIONED_BURN_DISCRIMINATOR);
}
function getPermissionedBurnCheckedInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      ["permissionedBurnDiscriminator", kit.getU8Encoder()],
...
function getPermissionedBurnCheckedInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    ["permissionedBurnDiscriminator", kit.getU8Decoder()],
    ["amount", kit.getU64Decoder()],
...
function getPermissionedBurnCheckedInstructionDataCodec() {
  return kit.combineCodec(
    getPermissionedBurnCheckedInstructionDataEncoder(),
    getPermissionedBurnCheckedInstructionDataDecoder()
  );
}
function getPermissionedBurnCheckedInstruction(input, config) {
  const programAddress = config?.programAddress ?? TOKEN_2022_PROGRAM_ADDRESS;
  const originalAccounts = {
    account: { value: input.account ?? null, isWritable: true },
    mint: { value: input.mint ?? null, isWritable: true },
...
function parsePermissionedBurnCheckedInstruction(instruction) {
  if (instruction.accounts.length < 4) {
    throw new Error("Not enough accounts");
  }
  let accountIndex = 0;
...
function getReallocateInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU8Encoder()],
      ["newExtensionTypes", kit.getArrayEncoder(getExtensionTypeEncoder(), { size: "remainder" })]
    ]),
...
function getReallocateInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU8Decoder()],
    ["newExtensionTypes", kit.getArrayDecoder(getExtensionTypeDecoder(), { size: "remainder" })]
  ]);
}
...
var REMOVE_TOKEN_METADATA_KEY_DISCRIMINATOR = new Uint8Array([234, 18, 32, 56, 89, 141, 37, 181]);
...
function getResumeInstructionDataCodec() {
  return kit.combineCodec(getResumeInstructionDataEncoder(), getResumeInstructionDataDecoder());
}
...
function getSetTransferFeeInstructionDataCodec() {
  return kit.combineCodec(getSetTransferFeeInstructionDataEncoder(), getSetTransferFeeInstructionDataDecoder());
}
...
function getTransferCheckedWithFeeTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(TRANSFER_CHECKED_WITH_FEE_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getUpdateDefaultAccountStateDefaultAccountStateDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_DEFAULT_ACCOUNT_STATE_DEFAULT_ACCOUNT_STATE_DISCRIMINATOR);
}
...
function getUpdateGroupMemberPointerGroupMemberPointerDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_GROUP_MEMBER_POINTER_GROUP_MEMBER_POINTER_DISCRIMINATOR);
}
...
function getUpdateGroupPointerGroupPointerDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_GROUP_POINTER_GROUP_POINTER_DISCRIMINATOR);
}
...
function getUpdateGroupPointerInstructionDataCodec() {
  return kit.combineCodec(getUpdateGroupPointerInstructionDataEncoder(), getUpdateGroupPointerInstructionDataDecoder());
}
...
function getUpdateMetadataPointerMetadataPointerDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_METADATA_POINTER_METADATA_POINTER_DISCRIMINATOR);
}
...
function getUpdateMultiplierScaledUiMintScaledUiAmountMintDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_MULTIPLIER_SCALED_UI_MINT_SCALED_UI_AMOUNT_MINT_DISCRIMINATOR);
}
...
var UPDATE_TOKEN_GROUP_MAX_SIZE_DISCRIMINATOR = new Uint8Array([108, 37, 171, 143, 248, 30, 18, 110]);
...
var UPDATE_TOKEN_GROUP_UPDATE_AUTHORITY_DISCRIMINATOR = new Uint8Array([161, 105, 88, 1, 237, 221, 216, 203]);
function getUpdateTokenGroupUpdateAuthorityDiscriminatorBytes() {
  return kit.getBytesEncoder().encode(UPDATE_TOKEN_GROUP_UPDATE_AUTHORITY_DISCRIMINATOR);
}
function getUpdateTokenGroupUpdateAuthorityInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getBytesEncoder()],
      ["newUpdateAuthority", kit.getOptionEncoder(kit.getAddressEncoder(), { prefix: null, noneValue: "zeroes" })]
    ]),
...
function getUpdateTokenGroupUpdateAuthorityInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getBytesDecoder()],
    ["newUpdateAuthority", kit.getOptionDecoder(kit.getAddressDecoder(), { prefix: null, noneValue: "zeroes" })]
  ]);
}
...
var UPDATE_TOKEN_METADATA_FIELD_DISCRIMINATOR = new Uint8Array([221, 233, 49, 45, 181, 202, 220, 200]);
...
function getUpdateTokenMetadataUpdateAuthorityDiscriminatorBytes() {
  return kit.getBytesEncoder().encode(UPDATE_TOKEN_METADATA_UPDATE_AUTHORITY_DISCRIMINATOR);
}
...
function getUpdateTransferHookTransferHookDiscriminatorBytes() {
  return kit.getU8Encoder().encode(UPDATE_TRANSFER_HOOK_TRANSFER_HOOK_DISCRIMINATOR);
}
...
function getUpdateTransferHookInstructionDataCodec() {
  return kit.combineCodec(getUpdateTransferHookInstructionDataEncoder(), getUpdateTransferHookInstructionDataDecoder());
}
...
function getWithdrawWithheldTokensFromAccountsDiscriminatorBytes() {
  return kit.getU8Encoder().encode(WITHDRAW_WITHHELD_TOKENS_FROM_ACCOUNTS_DISCRIMINATOR);
}
...
function getWithdrawWithheldTokensFromAccountsTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(WITHDRAW_WITHHELD_TOKENS_FROM_ACCOUNTS_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getWithdrawWithheldTokensFromMintDiscriminatorBytes() {
  return kit.getU8Encoder().encode(WITHDRAW_WITHHELD_TOKENS_FROM_MINT_DISCRIMINATOR);
}
...
function getWithdrawWithheldTokensFromMintTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(WITHDRAW_WITHHELD_TOKENS_FROM_MINT_TRANSFER_FEE_DISCRIMINATOR);
}
...
function getWithdrawWithheldTokensFromMintForConfidentialTransferFeeDiscriminatorBytes() {
  return kit.getU8Encoder().encode(WITHDRAW_WITHHELD_TOKENS_FROM_MINT_FOR_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR);
}
...
var Token2022Instruction = /* @__PURE__ */ ((Token2022Instruction2) => {
  ...
  Token2022Instruction2[Token2022Instruction2["UnwrapLamports"] = 87] = "UnwrapLamports";
  Token2022Instruction2[Token2022Instruction2["InitializePermissionedBurn"] = 88] = "InitializePermissionedBurn";
  Token2022Instruction2[Token2022Instruction2["PermissionedBurn"] = 89] = "PermissionedBurn";
  Token2022Instruction2[Token2022Instruction2["PermissionedBurnChecked"] = 90] = "PermissionedBurnChecked";
...
function identifyToken2022Instruction(instruction) {
  ...
  if (kit.containsBytes(data, new Uint8Array([210, 225, 30, 162, 88, 184, 77, 141]), 0)) {
    return 78 /* InitializeTokenMetadata */;
  }
  if (kit.containsBytes(data, new Uint8Array([221, 233, 49, 45, 181, 202, 220, 200]), 0)) {
  ...
  if (kit.containsBytes(data, new Uint8Array([215, 228, 166, 228, 84, 100, 86, 123]), 0)) {
    return 81 /* UpdateTokenMetadataUpdateAuthority */;
  }
  if (kit.containsBytes(data, new Uint8Array([250, 166, 180, 250, 13, 12, 184, 70]), 0)) {
  ...
  if (kit.containsBytes(data, new Uint8Array([108, 37, 171, 143, 248, 30, 18, 110]), 0)) {
    return 84 /* UpdateTokenGroupMaxSize */;
  }
  if (kit.containsBytes(data, new Uint8Array([161, 105, 88, 1, 237, 221, 216, 203]), 0)) {
    return 85 /* UpdateTokenGroupUpdateAuthority */;
  }
  if (kit.containsBytes(data, new Uint8Array([152, 32, 222, 176, 223, 237, 116, 134]), 0)) {
    return 86 /* InitializeTokenGroupMember */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(45), 0)) {
    return 87 /* UnwrapLamports */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(46), 0) && kit.containsBytes(data, kit.getU8Encoder().encode(0), 1)) {
    return 88 /* InitializePermissionedBurn */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(46), 0) && kit.containsBytes(data, kit.getU8Encoder().encode(1), 1)) {
    return 89 /* PermissionedBurn */;
  }
  if (kit.containsBytes(data, kit.getU8Encoder().encode(46), 0) && kit.containsBytes(data, kit.getU8Encoder().encode(2), 1)) {
    return 90 /* PermissionedBurnChecked */;
  }
  throw new Error("The provided instruction could not be identified as a token-2022 instruction.");
}
function parseToken2022Instruction(instruction) {
  const instructionType = identifyToken2022Instruction(instruction);
  switch (instructionType) {
    case 0 /* InitializeMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 0 /* InitializeMint */,
    ...
    case 10 /* FreezeAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 10 /* FreezeAccount */,
    ...
    case 13 /* ApproveChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 13 /* ApproveChecked */,
    ...
    case 14 /* MintToChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 14 /* MintToChecked */,
    ...
    case 25 /* InitializeMintCloseAuthority */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 25 /* InitializeMintCloseAuthority */,
        ...parseInitializeMintCloseAuthorityInstruction(instruction)
      };
    }
    case 26 /* InitializeTransferFeeConfig */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 26 /* InitializeTransferFeeConfig */,
        ...parseInitializeTransferFeeConfigInstruction(instruction)
      };
    }
    case 27 /* TransferCheckedWithFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 27 /* TransferCheckedWithFee */,
        ...parseTransferCheckedWithFeeInstruction(instruction)
      };
    }
    case 28 /* WithdrawWithheldTokensFromMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 28 /* WithdrawWithheldTokensFromMint */,
        ...parseWithdrawWithheldTokensFromMintInstruction(instruction)
      };
    }
    case 29 /* WithdrawWithheldTokensFromAccounts */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 29 /* WithdrawWithheldTokensFromAccounts */,
        ...parseWithdrawWithheldTokensFromAccountsInstruction(instruction)
      };
    }
    case 30 /* HarvestWithheldTokensToMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 30 /* HarvestWithheldTokensToMint */,
        ...parseHarvestWithheldTokensToMintInstruction(instruction)
      };
    }
    case 31 /* SetTransferFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 31 /* SetTransferFee */,
        ...parseSetTransferFeeInstruction(instruction)
      };
    }
    case 32 /* InitializeConfidentialTransferMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 32 /* InitializeConfidentialTransferMint */,
        ...parseInitializeConfidentialTransferMintInstruction(instruction)
      };
    }
    case 33 /* UpdateConfidentialTransferMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 33 /* UpdateConfidentialTransferMint */,
        ...parseUpdateConfidentialTransferMintInstruction(instruction)
      };
    }
    case 34 /* ConfigureConfidentialTransferAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 34 /* ConfigureConfidentialTransferAccount */,
        ...parseConfigureConfidentialTransferAccountInstruction(instruction)
      };
    }
    case 35 /* ApproveConfidentialTransferAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 35 /* ApproveConfidentialTransferAccount */,
        ...parseApproveConfidentialTransferAccountInstruction(instruction)
      };
    }
    case 36 /* EmptyConfidentialTransferAccount */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 36 /* EmptyConfidentialTransferAccount */,
        ...parseEmptyConfidentialTransferAccountInstruction(instruction)
      };
    }
    case 37 /* ConfidentialDeposit */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 37 /* ConfidentialDeposit */,
        ...parseConfidentialDepositInstruction(instruction)
      };
    }
    case 38 /* ConfidentialWithdraw */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 38 /* ConfidentialWithdraw */,
        ...parseConfidentialWithdrawInstruction(instruction)
      };
    }
    case 39 /* ConfidentialTransfer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 39 /* ConfidentialTransfer */,
        ...parseConfidentialTransferInstruction(instruction)
      };
    }
    case 40 /* ApplyConfidentialPendingBalance */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 40 /* ApplyConfidentialPendingBalance */,
        ...parseApplyConfidentialPendingBalanceInstruction(instruction)
      };
    }
    case 41 /* EnableConfidentialCredits */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 41 /* EnableConfidentialCredits */,
        ...parseEnableConfidentialCreditsInstruction(instruction)
      };
    }
    case 42 /* DisableConfidentialCredits */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 42 /* DisableConfidentialCredits */,
        ...parseDisableConfidentialCreditsInstruction(instruction)
      };
    }
    case 43 /* EnableNonConfidentialCredits */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 43 /* EnableNonConfidentialCredits */,
        ...parseEnableNonConfidentialCreditsInstruction(instruction)
      };
    }
    case 44 /* DisableNonConfidentialCredits */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 44 /* DisableNonConfidentialCredits */,
        ...parseDisableNonConfidentialCreditsInstruction(instruction)
      };
    }
    case 45 /* ConfidentialTransferWithFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 45 /* ConfidentialTransferWithFee */,
        ...parseConfidentialTransferWithFeeInstruction(instruction)
      };
    }
    case 46 /* InitializeDefaultAccountState */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 46 /* InitializeDefaultAccountState */,
        ...parseInitializeDefaultAccountStateInstruction(instruction)
      };
    }
    case 47 /* UpdateDefaultAccountState */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 47 /* UpdateDefaultAccountState */,
        ...parseUpdateDefaultAccountStateInstruction(instruction)
      };
    }
    case 48 /* Reallocate */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 48 /* Reallocate */, ...parseReallocateInstruction(instruction) };
    }
    case 49 /* EnableMemoTransfers */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 49 /* EnableMemoTransfers */,
        ...parseEnableMemoTransfersInstruction(instruction)
      };
    }
    case 50 /* DisableMemoTransfers */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 50 /* DisableMemoTransfers */,
        ...parseDisableMemoTransfersInstruction(instruction)
      };
    }
    case 51 /* CreateNativeMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 51 /* CreateNativeMint */,
        ...parseCreateNativeMintInstruction(instruction)
      };
    }
    case 52 /* InitializeNonTransferableMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 52 /* InitializeNonTransferableMint */,
        ...parseInitializeNonTransferableMintInstruction(instruction)
      };
    }
    case 53 /* InitializeInterestBearingMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 53 /* InitializeInterestBearingMint */,
        ...parseInitializeInterestBearingMintInstruction(instruction)
      };
    }
    case 54 /* UpdateRateInterestBearingMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 54 /* UpdateRateInterestBearingMint */,
        ...parseUpdateRateInterestBearingMintInstruction(instruction)
      };
    }
    case 55 /* EnableCpiGuard */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 55 /* EnableCpiGuard */,
        ...parseEnableCpiGuardInstruction(instruction)
      };
    }
    case 56 /* DisableCpiGuard */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 56 /* DisableCpiGuard */,
        ...parseDisableCpiGuardInstruction(instruction)
      };
    }
    case 57 /* InitializePermanentDelegate */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 57 /* InitializePermanentDelegate */,
        ...parseInitializePermanentDelegateInstruction(instruction)
      };
    }
    case 58 /* InitializeTransferHook */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 58 /* InitializeTransferHook */,
        ...parseInitializeTransferHookInstruction(instruction)
      };
    }
    case 59 /* UpdateTransferHook */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 59 /* UpdateTransferHook */,
        ...parseUpdateTransferHookInstruction(instruction)
      };
    }
    case 60 /* InitializeConfidentialTransferFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 60 /* InitializeConfidentialTransferFee */,
        ...parseInitializeConfidentialTransferFeeInstruction(instruction)
      };
    }
    case 61 /* WithdrawWithheldTokensFromMintForConfidentialTransferFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 61 /* WithdrawWithheldTokensFromMintForConfidentialTransferFee */,
        ...parseWithdrawWithheldTokensFromMintForConfidentialTransferFeeInstruction(instruction)
      };
    }
    case 62 /* WithdrawWithheldTokensFromAccountsForConfidentialTransferFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 62 /* WithdrawWithheldTokensFromAccountsForConfidentialTransferFee */,
        ...parseWithdrawWithheldTokensFromAccountsForConfidentialTransferFeeInstruction(instruction)
      };
    }
    case 63 /* HarvestWithheldTokensToMintForConfidentialTransferFee */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 63 /* HarvestWithheldTokensToMintForConfidentialTransferFee */,
        ...parseHarvestWithheldTokensToMintForConfidentialTransferFeeInstruction(instruction)
      };
    }
    case 64 /* EnableHarvestToMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 64 /* EnableHarvestToMint */,
        ...parseEnableHarvestToMintInstruction(instruction)
      };
    }
    case 65 /* DisableHarvestToMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 65 /* DisableHarvestToMint */,
        ...parseDisableHarvestToMintInstruction(instruction)
      };
    }
    case 66 /* WithdrawExcessLamports */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 66 /* WithdrawExcessLamports */,
        ...parseWithdrawExcessLamportsInstruction(instruction)
      };
    }
    case 67 /* InitializeMetadataPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 67 /* InitializeMetadataPointer */,
        ...parseInitializeMetadataPointerInstruction(instruction)
      };
    }
    case 68 /* UpdateMetadataPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 68 /* UpdateMetadataPointer */,
        ...parseUpdateMetadataPointerInstruction(instruction)
      };
    }
    case 69 /* InitializeGroupPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 69 /* InitializeGroupPointer */,
        ...parseInitializeGroupPointerInstruction(instruction)
      };
    }
    case 70 /* UpdateGroupPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 70 /* UpdateGroupPointer */,
        ...parseUpdateGroupPointerInstruction(instruction)
      };
    }
    case 71 /* InitializeGroupMemberPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 71 /* InitializeGroupMemberPointer */,
        ...parseInitializeGroupMemberPointerInstruction(instruction)
      };
    }
    case 72 /* UpdateGroupMemberPointer */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 72 /* UpdateGroupMemberPointer */,
        ...parseUpdateGroupMemberPointerInstruction(instruction)
      };
    }
    case 73 /* InitializeScaledUiAmountMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 73 /* InitializeScaledUiAmountMint */,
        ...parseInitializeScaledUiAmountMintInstruction(instruction)
      };
    }
    case 74 /* UpdateMultiplierScaledUiMint */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 74 /* UpdateMultiplierScaledUiMint */,
        ...parseUpdateMultiplierScaledUiMintInstruction(instruction)
      };
    }
    case 75 /* InitializePausableConfig */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 75 /* InitializePausableConfig */,
        ...parseInitializePausableConfigInstruction(instruction)
      };
    }
    case 76 /* Pause */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 76 /* Pause */, ...parsePauseInstruction(instruction) };
    }
    case 77 /* Resume */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return { instructionType: 77 /* Resume */, ...parseResumeInstruction(instruction) };
    }
    case 78 /* InitializeTokenMetadata */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 78 /* InitializeTokenMetadata */,
        ...parseInitializeTokenMetadataInstruction(instruction)
      };
    }
    case 79 /* UpdateTokenMetadataField */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 79 /* UpdateTokenMetadataField */,
        ...parseUpdateTokenMetadataFieldInstruction(instruction)
      };
    }
    case 80 /* RemoveTokenMetadataKey */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 80 /* RemoveTokenMetadataKey */,
        ...parseRemoveTokenMetadataKeyInstruction(instruction)
      };
    }
    case 81 /* UpdateTokenMetadataUpdateAuthority */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 81 /* UpdateTokenMetadataUpdateAuthority */,
        ...parseUpdateTokenMetadataUpdateAuthorityInstruction(instruction)
      };
    }
    case 82 /* EmitTokenMetadata */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 82 /* EmitTokenMetadata */,
        ...parseEmitTokenMetadataInstruction(instruction)
      };
    }
    case 83 /* InitializeTokenGroup */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 83 /* InitializeTokenGroup */,
        ...parseInitializeTokenGroupInstruction(instruction)
      };
    }
    case 84 /* UpdateTokenGroupMaxSize */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 84 /* UpdateTokenGroupMaxSize */,
        ...parseUpdateTokenGroupMaxSizeInstruction(instruction)
      };
    }
    case 85 /* UpdateTokenGroupUpdateAuthority */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 85 /* UpdateTokenGroupUpdateAuthority */,
        ...parseUpdateTokenGroupUpdateAuthorityInstruction(instruction)
      };
    }
    case 86 /* InitializeTokenGroupMember */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 86 /* InitializeTokenGroupMember */,
        ...parseInitializeTokenGroupMemberInstruction(instruction)
      };
    }
    case 87 /* UnwrapLamports */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 87 /* UnwrapLamports */,
        ...parseUnwrapLamportsInstruction(instruction)
      };
    }
    case 88 /* InitializePermissionedBurn */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 88 /* InitializePermissionedBurn */,
        ...parseInitializePermissionedBurnInstruction(instruction)
      };
    }
    case 89 /* PermissionedBurn */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 89 /* PermissionedBurn */,
        ...parsePermissionedBurnInstruction(instruction)
      };
    }
    case 90 /* PermissionedBurnChecked */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 90 /* PermissionedBurnChecked */,
...
function isToken2022Error(error, transactionMessage, code) {
  return kit.isProgramError(error, transactionMessage, TOKEN_2022_PROGRAM_ADDRESS, code);
}
  ...
  return extensions.flatMap((extension2) => {
    switch (extension2.__kind) {
      ...
      case "PermissionedBurn": {
        const authority = kit.isOption(extension2.authority) ? extension2.authority : kit.wrapNullable(extension2.authority);
        if (kit.isNone(authority)) {
...
function getTokenSize(extensions) {
  ...
  const tvlEncoder = kit.getHiddenPrefixEncoder(kit.getArrayEncoder(getExtensionEncoder(), { size: "remainder" }), [
    kit.getConstantEncoder(kit.getU8Encoder().encode(2))
  ]);
...
exports.INITIALIZE_PERMISSIONED_BURN_DISCRIMINATOR = INITIALIZE_PERMISSIONED_BURN_DISCRIMINATOR;
exports.INITIALIZE_PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR = INITIALIZE_PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR;
...
exports.PERMISSIONED_BURN_CHECKED_DISCRIMINATOR = PERMISSIONED_BURN_CHECKED_DISCRIMINATOR;
exports.PERMISSIONED_BURN_CHECKED_PERMISSIONED_BURN_DISCRIMINATOR = PERMISSIONED_BURN_CHECKED_PERMISSIONED_BURN_DISCRIMINATOR;
exports.PERMISSIONED_BURN_DISCRIMINATOR = PERMISSIONED_BURN_DISCRIMINATOR;
exports.PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR = PERMISSIONED_BURN_PERMISSIONED_BURN_DISCRIMINATOR;
...
exports.getInitializePermissionedBurnDiscriminatorBytes = getInitializePermissionedBurnDiscriminatorBytes;
exports.getInitializePermissionedBurnInstruction = getInitializePermissionedBurnInstruction;
exports.getInitializePermissionedBurnInstructionDataCodec = getInitializePermissionedBurnInstructionDataCodec;
exports.getInitializePermissionedBurnInstructionDataDecoder = getInitializePermissionedBurnInstructionDataDecoder;
exports.getInitializePermissionedBurnInstructionDataEncoder = getInitializePermissionedBurnInstructionDataEncoder;
exports.getInitializePermissionedBurnPermissionedBurnDiscriminatorBytes = getInitializePermissionedBurnPermissionedBurnDiscriminatorBytes;
...
exports.getPermissionedBurnCheckedDiscriminatorBytes = getPermissionedBurnCheckedDiscriminatorBytes;
exports.getPermissionedBurnCheckedInstruction = getPermissionedBurnCheckedInstruction;
exports.getPermissionedBurnCheckedInstructionDataCodec = getPermissionedBurnCheckedInstructionDataCodec;
exports.getPermissionedBurnCheckedInstructionDataDecoder = getPermissionedBurnCheckedInstructionDataDecoder;
exports.getPermissionedBurnCheckedInstructionDataEncoder = getPermissionedBurnCheckedInstructionDataEncoder;
exports.getPermissionedBurnCheckedPermissionedBurnDiscriminatorBytes = getPermissionedBurnCheckedPermissionedBurnDiscriminatorBytes;
exports.getPermissionedBurnDiscriminatorBytes = getPermissionedBurnDiscriminatorBytes;
exports.getPermissionedBurnInstruction = getPermissionedBurnInstruction;
exports.getPermissionedBurnInstructionDataCodec = getPermissionedBurnInstructionDataCodec;
exports.getPermissionedBurnInstructionDataDecoder = getPermissionedBurnInstructionDataDecoder;
exports.getPermissionedBurnInstructionDataEncoder = getPermissionedBurnInstructionDataEncoder;
exports.getPermissionedBurnPermissionedBurnDiscriminatorBytes = getPermissionedBurnPermissionedBurnDiscriminatorBytes;
...
exports.parseInitializePermissionedBurnInstruction = parseInitializePermissionedBurnInstruction;
...
exports.parsePermissionedBurnCheckedInstruction = parsePermissionedBurnCheckedInstruction;
exports.parsePermissionedBurnInstruction = parsePermissionedBurnInstruction;
...
exports.parseToken2022Instruction = parseToken2022Instruction;
