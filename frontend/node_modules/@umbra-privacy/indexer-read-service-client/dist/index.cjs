...
var ReadServiceClient = class {
  ...
  async getBatchProof(treeIndex, insertionIndices) {
    return this.post(
      ...
      "getBatchProof",
      indexerProtoGen.BatchProofResponseSchema,
