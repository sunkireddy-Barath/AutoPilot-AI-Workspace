import { j as AesDecryptorFunction, k as AesEncryptorFunction, d as IUmbraClient } from '../client-Cqv_5hHQ.js';
 ...
 */
declare function getAesEncryptor(): AesEncryptorFunction;
/**
 ...
 */
declare function getAesDecryptor(): AesDecryptorFunction;
/**
 ...
 */
declare const defaultAesEncryptor: AesEncryptorFunction;
/**
 ...
 */
declare const defaultAesDecryptor: AesDecryptorFunction;
 ...
 * @public
 */
declare function buildPersonalizationString(client: IUmbraClient): Uint8Array;
/**
 ...
 * @public
 */
interface GetPersonalizationStringBuilderArgs {
    /**
 ...
 * @public
 */
type PersonalizationStringBuilderFunction = () => Uint8Array;
/**
 ...
 * @public
 */
declare function getPersonalizationStringBuilder(args: GetPersonalizationStringBuilderArgs): PersonalizationStringBuilderFunction;
 ...
 * @public
 */
type SplitAddressFunction = (address: Address) => AddressSplitResult;
/**
 ...
 * @public
 */
interface PseudorandomU512DeriverArgs {
    /**
 ...
 * @public
 */
interface PseudorandomU512DeriverDeps {
    /**
 ...
 * @public
 */
declare function getPseudorandomU512Deriver(args: PseudorandomU512DeriverArgs, deps?: PseudorandomU512DeriverDeps): PseudorandomU512DeriverFunction;
/**
 * Required arguments for creating a master-seed-based BN254 field element deriver.
 *
 * @public
 */
interface MasterSeedBasedFieldElementDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface MasterSeedBasedFieldElementDeriverDeps {
    /**
 ...
 * @public
 */
declare function getMasterSeedBasedFieldElementDeriver(args: MasterSeedBasedFieldElementDeriverArgs, deps?: MasterSeedBasedFieldElementDeriverDeps): MasterSeedBasedFieldElementDeriverFunction;
/**
 * Required arguments for creating an ephemeral master seed generator.
 *
 * @public
 */
interface EphemeralMasterSeedDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface EphemeralMasterSeedDeriverDeps {
    /**
     * Custom pseudorandom U512 generator.
     *
     * @remarks
 ...
 * @public
 */
declare function getEphemeralMasterSeedDeriver(args: EphemeralMasterSeedDeriverArgs, deps?: EphemeralMasterSeedDeriverDeps): EphemeralMasterSeedDeriverFunction;
/**
 * Required arguments for creating a master viewing key generator.
 *
 * @public
 */
interface MasterViewingKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface MasterViewingKeyDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @remarks
 ...
 * @public
 */
declare function getMasterViewingKeyDeriver(args: MasterViewingKeyDeriverArgs, deps?: MasterViewingKeyDeriverDeps): MasterViewingKeyDeriverFunction;
/**
 * Required arguments for creating a master viewing key blinding factor generator.
 *
 * @public
 */
interface MasterViewingKeyBlindingFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface MasterViewingKeyBlindingFactorDeriverDeps {
    /**
 ...
 * @public
 */
declare function getMasterViewingKeyBlindingFactorDeriver(args: MasterViewingKeyBlindingFactorDeriverArgs, deps?: MasterViewingKeyBlindingFactorDeriverDeps): MasterViewingKeyBlindingFactorDeriverFunction;
/**
 * Required arguments for creating a Poseidon private key generator.
 *
 * @public
 */
interface PoseidonPrivateKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface PoseidonPrivateKeyDeriverDeps {
    /**
     * Custom BN254 field element deriver.
     *
     * @remarks
 ...
 * @public
 */
declare function getPoseidonPrivateKeyDeriver(args: PoseidonPrivateKeyDeriverArgs, deps?: PoseidonPrivateKeyDeriverDeps): PoseidonPrivateKeyDeriverFunction;
/**
 * Required arguments for creating a Poseidon blinding factor generator.
 *
 * @public
 */
interface PoseidonBlindingFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface PoseidonBlindingFactorDeriverDeps {
    /**
     * Custom BN254 field element deriver.
     *
     * @defaultValue `getMasterSeedBasedFieldElementDeriver({ client })`
 ...
 * @public
 */
declare function getPoseidonBlindingFactorDeriver(args: PoseidonBlindingFactorDeriverArgs, deps?: PoseidonBlindingFactorDeriverDeps): PoseidonBlindingFactorDeriverFunction;
/**
 * Required arguments for creating a mint viewing key generator.
 *
 * @public
 */
interface MintViewingKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface MintViewingKeyDeriverDeps {
    /**
 ...
 * @public
 */
declare function getMintViewingKeyDeriver(args: MintViewingKeyDeriverArgs, deps?: MintViewingKeyDeriverDeps): MintViewingKeyDeriverFunction;
/**
 ...
 * @public
 */
interface TimeViewingKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface TimeViewingKeyDeriverDeps {
    /**
     * Custom Poseidon hash function.
     *
     * @remarks
 ...
 * @public
 */
declare function getYearlyViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): YearlyViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
declare function getMonthlyViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): MonthlyViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
declare function getDailyViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): DailyViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
declare function getHourlyViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): HourlyViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
declare function getMinuteViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): MinuteViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
declare function getSecondViewingKeyDeriver(args: TimeViewingKeyDeriverArgs, deps?: TimeViewingKeyDeriverDeps): SecondViewingKeyGeneratorFunction;
/**
 ...
 * @public
 */
interface X25519KeypairDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface X25519KeypairDeriverDeps {
    /**
     * Custom pseudorandom U512 generator.
     *
     * @remarks
 ...
 * @public
 */
declare function getUserAccountX25519KeypairDeriver(args: X25519KeypairDeriverArgs, deps?: X25519KeypairDeriverDeps): Curve25519KeypairGeneratorFunction;
/**
 ...
 * @public
 */
declare function getMasterViewingKeyX25519KeypairDeriver(args: X25519KeypairDeriverArgs, deps?: X25519KeypairDeriverDeps): Curve25519KeypairGeneratorFunction;
/**
 ...
 * @public
 */
declare function getMintX25519KeypairDeriver(args: X25519KeypairDeriverArgs, deps?: X25519KeypairDeriverDeps): MintX25519KeypairDeriverFunction;
/**
 * Required arguments for creating a Rescue encryption commitment blinding factor generator.
 *
 * @public
 */
interface RescueCommitmentBlindingFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface RescueCommitmentBlindingFactorDeriverDeps {
    /**
     * Custom pseudorandom U512 generator.
     *
     * @defaultValue `getPseudorandomU512Deriver({ client })`
 ...
 * @public
 */
declare function getRescueCommitmentBlindingFactorDeriver(args: RescueCommitmentBlindingFactorDeriverArgs, deps?: RescueCommitmentBlindingFactorDeriverDeps): RescueCommitmentBlindingFactorDeriverFunction;
/**
 * Required arguments for creating a random factor for polynomial commitment generator.
 *
 * @public
 */
interface PolynomialCommitmentFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @remarks
 ...
 * @public
 */
interface PolynomialCommitmentFactorDeriverDeps {
    /**
     * Custom pseudorandom U512 generator.
     *
     * @defaultValue `getPseudorandomU512Deriver({ client })`
 ...
 * @public
 */
declare function getPolynomialCommitmentFactorDeriver(args: PolynomialCommitmentFactorDeriverArgs, deps?: PolynomialCommitmentFactorDeriverDeps): PolynomialCommitmentFactorDeriverFunction;
/**
 ...
 * @public
 */
type ModifiedGenerationIndexDeriverFunction = (masterSeed: MasterSeed, generationIndex: U256) => U128;
/**
 ...
 * @public
 */
declare function deriveModifiedGenerationIndexForSenderClaim(masterSeed: MasterSeed, generationIndex: U256): U128;
/**
 ...
 * @public
 */
declare function deriveModifiedGenerationIndexForReceiverClaim(masterSeed: MasterSeed, generationIndex: U256): U128;
/**
 ...
 * @public
 */
type Keccak512BasedBn254FieldElementDeriverFunction = (seed: Uint8Array) => Bn254FieldElement;
/**
 * Optional dependencies for the Keccak512-based BN254 field element deriver.
 *
 * @public
 */
interface Keccak512BasedBn254FieldElementDeriverDeps {
    /**
     * Custom constant-time BN254 field element sampler.
     *
     * @remarks
 ...
 * @public
 */
declare function deriveBn254FieldElementFromKeccak512(seed: Uint8Array, deps?: Keccak512BasedBn254FieldElementDeriverDeps): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function getBn254FieldElementFromKeccak512Deriver(deps?: Keccak512BasedBn254FieldElementDeriverDeps): Keccak512BasedBn254FieldElementDeriverFunction;
/**
 ...
 * @public
 */
declare function deriveKeystreamBlindingFactor(offset: U256): Bn254FieldElement;
/**
 * Required arguments for creating an ephemeral Rescue encryption commitment blinding factor generator.
 *
 * @public
 */
interface EphemeralRescueCommitmentBlindingFactorDeriverArgs {
    /**
 ...
 * @public
 */
interface EphemeralRescueCommitmentBlindingFactorDeriverDeps {
    /**
     ...
     * @readonly
     */
    readonly kmac256?: typeof kmac256;
    /**
 ...
 * @public
 */
declare function getEphemeralRescueCommitmentBlindingFactorDeriver(args: EphemeralRescueCommitmentBlindingFactorDeriverArgs, deps?: EphemeralRescueCommitmentBlindingFactorDeriverDeps): EphemeralRescueCommitmentBlindingFactorDeriverFunction;
/**
 ...
 * @public
 */
declare function deriveEphemeralMasterViewingKey(expandedGenerationIndex: U256): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function deriveEphemeralMasterViewingKeyBlindingFactor(expandedGenerationIndex: U256): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function deriveEphemeralPoseidonPrivateKey(expandedGenerationIndex: U256): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function deriveEphemeralPoseidonPrivateKeyBlindingFactor(expandedGenerationIndex: U256): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function expandModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Uint8Array;
/**
 ...
 * @public
 */
declare function deriveNullifierFromModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function deriveRandomSecretFromModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Bn254FieldElement;
/**
 ...
 * @public
 */
declare function deriveProofAccountOffsetFromModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Uint8Array;
/**
 ...
 * @public
 */
declare function deriveRandomFactorForPolynomialCommitmentFromModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Curve25519FieldElement;
/**
 ...
 * @public
 */
declare function deriveRescueEncryptionCommitmentBlindingFactorFromModifiedGenerationIndex(modifiedGenerationIndex: Uint8Array): Bn254FieldElement;
/**
 * Required arguments for creating an ephemeral UTXO master viewing key generator.
 *
 * @public
 */
interface EphemeralUtxoMasterViewingKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoMasterViewingKeyDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoMasterViewingKeyDeriver(args: EphemeralUtxoMasterViewingKeyDeriverArgs, deps?: EphemeralUtxoMasterViewingKeyDeriverDeps): EphemeralUtxoMasterViewingKeyDeriverFunction;
/**
 * Required arguments for creating an ephemeral UTXO MVK blinding factor generator.
 *
 * @public
 */
interface EphemeralUtxoMasterViewingKeyBlindingFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoMasterViewingKeyBlindingFactorDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoMasterViewingKeyBlindingFactorDeriver(args: EphemeralUtxoMasterViewingKeyBlindingFactorDeriverArgs, deps?: EphemeralUtxoMasterViewingKeyBlindingFactorDeriverDeps): EphemeralUtxoMasterViewingKeyBlindingFactorDeriverFunction;
/**
 * Required arguments for creating an ephemeral UTXO Poseidon private key generator.
 *
 * @public
 */
interface EphemeralUtxoPoseidonPrivateKeyDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoPoseidonPrivateKeyDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoPoseidonPrivateKeyDeriver(args: EphemeralUtxoPoseidonPrivateKeyDeriverArgs, deps?: EphemeralUtxoPoseidonPrivateKeyDeriverDeps): EphemeralUtxoPoseidonPrivateKeyDeriverFunction;
/**
 * Required arguments for creating an ephemeral UTXO Poseidon PK blinding factor generator.
 *
 * @public
 */
interface EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriver(args: EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverArgs, deps?: EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverDeps): EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverFunction;
/**
 * Required arguments for creating an ephemeral UTXO nullifier generator.
 *
 * @public
 */
interface EphemeralUtxoNullifierDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoNullifierDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoNullifierDeriver(args: EphemeralUtxoNullifierDeriverArgs, deps?: EphemeralUtxoNullifierDeriverDeps): EphemeralUtxoNullifierDeriverFunction;
/**
 * Required arguments for creating an ephemeral UTXO H2 random secret generator.
 *
 * @public
 */
interface EphemeralUtxoH2RandomSecretDeriverArgs {
    /**
     * The Umbra client used to access the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface EphemeralUtxoH2RandomSecretDeriverDeps {
    /**
     * Custom KMAC256 implementation.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getEphemeralUtxoH2RandomSecretDeriver(args: EphemeralUtxoH2RandomSecretDeriverArgs, deps?: EphemeralUtxoH2RandomSecretDeriverDeps): EphemeralUtxoH2RandomSecretDeriverFunction;
/**
 * Required arguments for creating a Poseidon keystream blinding factor generator.
 *
 * @public
 */
interface PoseidonKeystreamBlindingFactorDeriverArgs {
    /**
     * The Umbra client providing access to the master seed and version information.
     *
     * @readonly
 ...
 * @public
 */
interface PoseidonKeystreamBlindingFactorDeriverDeps {
    /**
     * Custom KMAC256 implementation for testing.
     *
     * @defaultValue `import("@noble/hashes/sha3-addons").kmac256`
 ...
 * @public
 */
declare function getPoseidonKeystreamBlindingFactorDeriver(args: PoseidonKeystreamBlindingFactorDeriverArgs, deps?: PoseidonKeystreamBlindingFactorDeriverDeps): PoseidonKeystreamBlindingFactorDeriverFunction;
 ...
 * @public
 */
declare function getFieldArithmetic(): FieldArithmetic;
/**
 ...
 * @public
 */
declare function getRescuePrimeHashFunction(deps?: RescuePrimeHashDeps): RescuePrimeHashFunction;
/**
 ...
 * @public
 */
declare function getRescueCipherInstance(sharedSecret: Uint8Array, deps?: RescueCipherDeps): RescueCipherInstance;
 ...
 * @public
 */
declare const MAX_POSEIDON_INPUTS = 12;
/**
 ...
 * @public
 */
declare const MAX_PRF_SEEDS = 11;
/**
 ...
 * @public
 */
declare function getPoseidonHasher(): PoseidonHashFunction;
/**
 ...
 * @public
 */
declare function getPoseidonPrf(deps?: PoseidonPrfDeps): PoseidonPrfFunction;
/**
 ...
 * @public
 */
interface PoseidonKeystreamGeneratorDeps {
    /**
 ...
 * @public
 */
declare function getPoseidonKeystreamGenerator(deps?: PoseidonKeystreamGeneratorDeps): PoseidonKeystreamGeneratorFunction;
/**
 ...
 * @public
 */
interface PoseidonEncryptorDeps {
    /**
 ...
 * @public
 */
interface PoseidonDecryptorDeps {
    /**
     * Custom keystream generator function.
     *
     * @remarks
     ...
     */
    readonly modSub?: ModuloSubFunction;
}
/**
 ...
 * @public
 */
declare function getPoseidonEncryptor(deps?: PoseidonEncryptorDeps): PoseidonEncryptorFunction;
/**
 ...
 * @public
 */
declare function getPoseidonDecryptor(deps?: PoseidonDecryptorDeps): PoseidonDecryptorFunction;
/**
 ...
 * @public
 */
declare const MAX_AGGREGATOR_INPUTS: number;
/**
 ...
 * @public
 */
type PoseidonAggregatorFunction = (inputs: readonly Bn254FieldElement[]) => Promise<Bn254FieldElement>;
/**
 ...
 * @public
 */
interface PoseidonAggregatorDeps {
    /**
     * Optional custom hasher function.
     *
     * @remarks
 ...
 * @public
 */
declare function getPoseidonAggregator(deps?: PoseidonAggregatorDeps): PoseidonAggregatorFunction;
 ...
 * @public
 */
declare function getUtxoCommitmentHashGenerator(deps?: H2GeneratorDeps): H2GeneratorFns;
/**
 ...
 * @public
 */
interface KeystreamCommitmentDeps {
    /**
     * Optional custom Poseidon hasher function.
     *
     * @remarks
 ...
 * @public
 */
declare function getKeystreamCommitmentGenerator(deps?: KeystreamCommitmentDeps): KeystreamCommitmentFunction;
 ...
 * ```
 */
type GetRescueCipherFunction = (sharedSecret: SharedSecret) => RescueCipherInstance;
/**
 ...
 * ```
 */
type GetRescueCipherFromKeyPairFunction = (privateKey: X25519PrivateKey, publicKey: X25519PublicKey) => RescueCipherInstance;
/**
 ...
 * ```
 */
interface RescueCipherFromKeyPairDeps {
    /**
 ...
 * @public
 */
interface RcEncryptorWithNonceDeps {
    /**
     * Optional custom cipher-from-key-pair factory.
     *
     * @defaultValue {@link getRescueCipherFromKeyPair}
 ...
 */
declare function getRescueCipher(sharedSecret: SharedSecret): RescueCipherInstance;
/**
 ...
 */
declare function getRescueCipherFromKeyPair(privateKey: X25519PrivateKey, publicKey: X25519PublicKey, deps?: RescueCipherFromKeyPairDeps): RescueCipherInstance;
/**
 ...
 */
declare function getRescueEncryptorFromPrivateKey(privateKey: X25519PrivateKey, deps: RcEncryptorDeps): RcEncryptorFunction;
/**
 ...
 */
declare function getRescueEncryptorWithNonceFromPrivateKey(privateKey: X25519PrivateKey, deps: RcEncryptorWithNonceDeps): RcEncryptorWithNonceFunction;
/**
 ...
 */
declare function getRescueDecryptorFromPrivateKey(privateKey: X25519PrivateKey, deps: RcDecryptorDeps): RcDecryptorFunction;
/**
 ...
 */
declare function getRescueKeyGeneratorFromPrivateKey(privateKey: X25519PrivateKey, deps: RcKeyGeneratorDeps): RcKeyGeneratorFunction;
 ...
 * @public
 */
type ConvertU256ToBase85LimbsFunction = (value: U256) => Base85LimbTuple;
/**
 * Optional dependency injection bag for
 ...
 * @public
 */
interface RescueCommitmentGeneratorDeps {
    /**
 ...
 * @public
 */
type RescueCommitmentGeneratorFunction = (encryptions: readonly RcCiphertext$1[], data: readonly Curve25519FieldElement[], keys: readonly Curve25519FieldElement[], blindingFactor: Bn254FieldElement, nonce: Nonce$1, arcisPublicKeyLow: U128, arcisPublicKeyHigh: U128) => Promise<Bn254FieldElement>;
/**
 ...
 */
declare function getRescueCommitmentGenerator(deps?: RescueCommitmentGeneratorDeps): RescueCommitmentGeneratorFunction;
 ...
 */
type RcCiphertext = SubSubSubBrandedType<Curve25519FieldElement$1, "RcCiphertext">;
/**
 ...
 */
type RcPlaintext = SubSubSubBrandedType<Curve25519FieldElement$1, "RcPlaintext">;
/**
 ...
 */
type RcKey = SubSubSubBrandedType<Curve25519FieldElement$1, "RcKey">;
/**
 ...
 */
type RcCounter = SubSubSubBrandedType<Curve25519FieldElement$1, "RcCounter">;
/**
 ...
 * @public
 */
declare const FIELD_PRIME = 57896044618658097711785492504343953926634992332820282019728792003956564819949n;
/**
 ...
 * @public
 */
declare const ALPHA_INVERSE = 34737626771194858627071295502606372355980995399692169211837275202373938891969n;
/**
 ...
 * @public
 */
declare const REDUCTION_CONST = 38n;
/**
 ...
 * @public
 */
declare const CIPHER_ROUND_COUNT = 10;
/**
 ...
 * @public
 */
declare const FIELD_ELEMENT_BYTE_LENGTH = 32;
/**
 ...
 * @public
 */
declare const HASH_STATE_SIZE = 12;
/**
 ...
 * @public
 */
declare const HASH_DIGEST_LENGTH = 5;
/**
 ...
 * @public
 */
declare const HASH_ROUND_COUNT = 8;
/**
 ...
 * @public
 */
declare const SHAKE256_CIPHER_SEED = "encrypt everything, compute anything";
/**
 ...
 * @public
 */
declare const SAMPLE_BUFFER_BYTE_LENGTH = 48;
/**
 ...
 * @readonly
 */
declare const PRECOMPUTED_FIELD_INVERSES: readonly bigint[];
 ...
 */
declare function getFiatShamirChallengeGeneratorFunction(): FiatShamirChallengeGeneratorFunction;
/**
 ...
 */
declare function getChallengePowersFunction(deps?: ChallengePowersDeps): ChallengePowersFunction;
/**
 ...
 */
declare function getPolynomialEvaluatorFunction(deps?: PolynomialEvaluatorDeps): PolynomialEvaluatorFunction;
/**
 ...
 */
declare function getModuloPowCurve25519Function(): ModuloPowCurve25519Function;
 ...
 * @public
 */
declare function getUserCommitmentGeneratorFunction(deps?: UserCommitmentGeneratorDeps): UserCommitmentGeneratorFunction;

export { AES_AUTH_TAG_LENGTH, AES_IV_LENGTH, AES_KEY_LENGTH, AES_METADATA_OVERHEAD, ALPHA, ALPHA_INVERSE, type AesCiphertextWithMetadata, AesDecryptorFunction, AesEncryptorFunction, type AesKey, type AesPlaintext, BLOCK_SIZE, CIPHER_ROUND_COUNT, ChallengePowersDeps, ChallengePowersFunction, type ConvertU256ToBase85LimbsFunction, Curve25519KeypairGeneratorFunction, DailyViewingKeyGeneratorFunction, type EphemeralMasterSeedDeriverArgs, type EphemeralMasterSeedDeriverDeps, EphemeralMasterSeedDeriverFunction, type EphemeralRescueCommitmentBlindingFactorDeriverArgs, type EphemeralRescueCommitmentBlindingFactorDeriverDeps, EphemeralRescueCommitmentBlindingFactorDeriverFunction, type EphemeralUtxoH2RandomSecretDeriverArgs, type EphemeralUtxoH2RandomSecretDeriverDeps, EphemeralUtxoH2RandomSecretDeriverFunction, type EphemeralUtxoMasterViewingKeyBlindingFactorDeriverArgs, type EphemeralUtxoMasterViewingKeyBlindingFactorDeriverDeps, EphemeralUtxoMasterViewingKeyBlindingFactorDeriverFunction, type EphemeralUtxoMasterViewingKeyDeriverArgs, type EphemeralUtxoMasterViewingKeyDeriverDeps, EphemeralUtxoMasterViewingKeyDeriverFunction, type EphemeralUtxoNullifierDeriverArgs, type EphemeralUtxoNullifierDeriverDeps, EphemeralUtxoNullifierDeriverFunction, type EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverArgs, type EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverDeps, EphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriverFunction, type EphemeralUtxoPoseidonPrivateKeyDeriverArgs, type EphemeralUtxoPoseidonPrivateKeyDeriverDeps, EphemeralUtxoPoseidonPrivateKeyDeriverFunction, FIELD_ELEMENT_BYTE_LENGTH, FIELD_PRIME, FiatShamirChallengeGeneratorFunction, FieldArithmetic, GROTH16_G1_BYTE_LENGTH, GROTH16_G2_BYTE_LENGTH, type GetPersonalizationStringBuilderArgs, type GetRescueCipherFromKeyPairFunction, type GetRescueCipherFunction, type Groth16Proof, type Groth16ProofA, type Groth16ProofB, type Groth16ProofC, type H2GeneratorDeps, H2GeneratorFns, HASH_CAPACITY, HASH_DIGEST_LENGTH, HASH_RATE, HASH_ROUND_COUNT, HASH_STATE_SIZE, HourlyViewingKeyGeneratorFunction, type Keccak512BasedBn254FieldElementDeriverDeps, type Keccak512BasedBn254FieldElementDeriverFunction, type KeystreamCommitmentDeps, KeystreamCommitmentFunction, MAX_AGGREGATOR_INPUTS, MAX_POSEIDON_INPUTS, MAX_PRF_SEEDS, type MasterSeedBasedFieldElementDeriverArgs, type MasterSeedBasedFieldElementDeriverDeps, MasterSeedBasedFieldElementDeriverFunction, type MasterViewingKeyBlindingFactorDeriverArgs, type MasterViewingKeyBlindingFactorDeriverDeps, MasterViewingKeyBlindingFactorDeriverFunction, type MasterViewingKeyDeriverArgs, type MasterViewingKeyDeriverDeps, MasterViewingKeyDeriverFunction, type MintViewingKeyDeriverArgs, type MintViewingKeyDeriverDeps, MintViewingKeyDeriverFunction, MintX25519KeypairDeriverFunction, MinuteViewingKeyGeneratorFunction, type ModifiedGenerationIndexDeriverFunction, ModuloPowCurve25519Function, MonthlyViewingKeyGeneratorFunction, NONCE_BYTES, type Nonce, OPTIONAL_DATA_BYTE_LENGTH, type OptionalData32, PRECOMPUTED_FIELD_INVERSES, type PersonalizationStringBuilderFunction, type PolynomialCommitmentFactorDeriverArgs, type PolynomialCommitmentFactorDeriverDeps, PolynomialCommitmentFactorDeriverFunction, PolynomialEvaluatorDeps, PolynomialEvaluatorFunction, type PoseidonAggregatorDeps, type PoseidonAggregatorFunction, type PoseidonBlindingFactorDeriverArgs, type PoseidonBlindingFactorDeriverDeps, PoseidonBlindingFactorDeriverFunction, type PoseidonDecryptorDeps, PoseidonDecryptorFunction, type PoseidonEncryptorDeps, PoseidonEncryptorFunction, PoseidonHashFunction, type PoseidonKeystreamBlindingFactorDeriverArgs, type PoseidonKeystreamBlindingFactorDeriverDeps, PoseidonKeystreamBlindingFactorDeriverFunction, type PoseidonKeystreamGeneratorDeps, PoseidonKeystreamGeneratorFunction, type PoseidonPrfDeps, PoseidonPrfFunction, type PoseidonPrivateKeyDeriverArgs, type PoseidonPrivateKeyDeriverDeps, PoseidonPrivateKeyDeriverFunction, type PseudorandomU512DeriverArgs, type PseudorandomU512DeriverDeps, PseudorandomU512DeriverFunction, REDUCTION_CONST, type RcCiphertext, type RcCounter, type RcDecryptorDeps, RcDecryptorFunction, type RcEncryptionNonce, type RcEncryptorDeps, RcEncryptorFunction, type RcEncryptorWithNonceDeps, RcEncryptorWithNonceFunction, type RcKey, type RcKeyGeneratorDeps, RcKeyGeneratorFunction, type RcPlaintext, RescueCipherDeps, type RescueCipherFromKeyPairDeps, RescueCipherInstance, type RescueCommitmentBlindingFactorDeriverArgs, type RescueCommitmentBlindingFactorDeriverDeps, RescueCommitmentBlindingFactorDeriverFunction, type RescueCommitmentGeneratorDeps, type RescueCommitmentGeneratorFunction, RescuePrimeHashDeps, RescuePrimeHashFunction, SAMPLE_BUFFER_BYTE_LENGTH, SECRET_BYTES, SHAKE256_CIPHER_SEED, SecondViewingKeyGeneratorFunction, type SplitAddressFunction, type TimeViewingKeyDeriverArgs, type TimeViewingKeyDeriverDeps, UserCommitmentGeneratorDeps, UserCommitmentGeneratorFunction, type X25519KeypairDeriverArgs, type X25519KeypairDeriverDeps, YearlyViewingKeyGeneratorFunction, ZK_PROOF_BYTE_LENGTH, type ZkProofBytes, assertAesCiphertextWithMetadata, assertAesKey, assertAesPlaintext, assertGroth16ProofA, assertGroth16ProofB, assertGroth16ProofC, assertOptionalData32, assertRcCiphertext, assertRcCounter, assertRcEncryptionNonce, assertRcKey, assertRcPlaintext, assertZkProofBytes, buildPersonalizationString, defaultAesDecryptor, defaultAesEncryptor, deriveBn254FieldElementFromKeccak512, deriveEphemeralMasterViewingKey, deriveEphemeralMasterViewingKeyBlindingFactor, deriveEphemeralPoseidonPrivateKey, deriveEphemeralPoseidonPrivateKeyBlindingFactor, deriveKeystreamBlindingFactor, deriveModifiedGenerationIndexForReceiverClaim, deriveModifiedGenerationIndexForSenderClaim, deriveNullifierFromModifiedGenerationIndex, deriveProofAccountOffsetFromModifiedGenerationIndex, deriveRandomFactorForPolynomialCommitmentFromModifiedGenerationIndex, deriveRandomSecretFromModifiedGenerationIndex, deriveRescueEncryptionCommitmentBlindingFactorFromModifiedGenerationIndex, expandModifiedGenerationIndex, getAesDecryptor, getAesEncryptor, getBn254FieldElementFromKeccak512Deriver, getChallengePowersFunction, getDailyViewingKeyDeriver, getEphemeralMasterSeedDeriver, getEphemeralRescueCommitmentBlindingFactorDeriver, getEphemeralUtxoH2RandomSecretDeriver, getEphemeralUtxoMasterViewingKeyBlindingFactorDeriver, getEphemeralUtxoMasterViewingKeyDeriver, getEphemeralUtxoNullifierDeriver, getEphemeralUtxoPoseidonPrivateKeyBlindingFactorDeriver, getEphemeralUtxoPoseidonPrivateKeyDeriver, getFiatShamirChallengeGeneratorFunction, getFieldArithmetic, getHourlyViewingKeyDeriver, getKeystreamCommitmentGenerator, getMasterSeedBasedFieldElementDeriver, getMasterViewingKeyBlindingFactorDeriver, getMasterViewingKeyDeriver, getMasterViewingKeyX25519KeypairDeriver, getMintViewingKeyDeriver, getMintX25519KeypairDeriver, getMinuteViewingKeyDeriver, getModuloPowCurve25519Function, getMonthlyViewingKeyDeriver, getPersonalizationStringBuilder, getPolynomialCommitmentFactorDeriver, getPolynomialEvaluatorFunction, getPoseidonAggregator, getPoseidonBlindingFactorDeriver, getPoseidonDecryptor, getPoseidonEncryptor, getPoseidonHasher, getPoseidonKeystreamBlindingFactorDeriver, getPoseidonKeystreamGenerator, getPoseidonPrf, getPoseidonPrivateKeyDeriver, getPseudorandomU512Deriver, getRescueCipher, getRescueCipherFromKeyPair, getRescueCipherInstance, getRescueCommitmentBlindingFactorDeriver, getRescueCommitmentGenerator, getRescueDecryptorFromPrivateKey, getRescueEncryptorFromPrivateKey, getRescueEncryptorWithNonceFromPrivateKey, getRescueKeyGeneratorFromPrivateKey, getRescuePrimeHashFunction, getSecondViewingKeyDeriver, getUserAccountX25519KeypairDeriver, getUserCommitmentGeneratorFunction, getUtxoCommitmentHashGenerator, getYearlyViewingKeyDeriver };
