...
// src/arcium/errors.ts
var ComputationMonitorError = class extends UmbraError {
  static {
    __name(this, "ComputationMonitorError");
  }
...
function isComputationMonitorError(error) {
  return error instanceof ComputationMonitorError;
}
__name(isComputationMonitorError, "isComputationMonitorError");
