...
export default function WorkflowsPage() {
  const { userId, setWorkflowGraph } = useStore()
    ...
    <div className="p-8 h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between glass p-2 px-4 border-white/5">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400 font-medium">4 Active Nodes</span>
            </div>
          </div>
      ...
      >
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          The Orchestrator has re-routed the Developer agent to handle "API Integration" earlier based on PM priority shift.
        </p>
